...
def load(h):
    ...
    def wrapped(h):
        ...
        latitudeOfFirstGridPoint = h.get('latitudeOfFirstGridPoint')
        longitudeOfFirstGridPoint = h.get('longitudeOfFirstGridPoint')
        latitudeOfLastGridPoint = h.get('latitudeOfLastGridPoint')
        longitudeOfLastGridPoint = h.get('longitudeOfLastGridPoint')
