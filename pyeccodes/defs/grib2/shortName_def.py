...
def load(h):
    ...
    def wrapped(h):
        ...
        scaledValueOfLowerLimit = h.get('scaledValueOfLowerLimit')
        probabilityType = h.get('probabilityType')
        scaleFactorOfLowerLimit = h.get('scaleFactorOfLowerLimit')
        ...
        if discipline == 0 and parameterCategory == 2 and parameterNumber == 22 and typeOfFirstFixedSurface == 103 and scaleFactorOfLowerLimit == 0 and scaledValueOfFirstFixedSurface == 10 and productDefinitionTemplateNumber == 9 and typeOfStatisticalProcessing == 2 and scaledValueOfLowerLimit == 10 and probabilityType == 3 and scaleFactorOfFirstFixedSurface == 0:
            return '10fgg10'
        ...
        if discipline == 10 and parameterCategory == 4 and parameterNumber == 14 and typeOfSecondFixedSurface == 255 and scaledValueOfFirstFixedSurface == 1 and scaleFactorOfFirstFixedSurface == 2 and typeOfFirstFixedSurface == 169:
            return 'mlotst010'

        aerosolType = h.get('aerosolType')
        is_aerosol = h.get('is_aerosol')

        if discipline == 0 and parameterCategory == 20 and parameterNumber == 2 and aerosolType == 62003 and is_aerosol == 1:
            return 'aermr18'

        is_aerosol_optical = h.get('is_aerosol_optical')
        typeOfWavelengthInterval = h.get('typeOfWavelengthInterval')
        scaleFactorOfFirstWavelength = h.get('scaleFactorOfFirstWavelength')
        scaledValueOfFirstWavelength = h.get('scaledValueOfFirstWavelength')
        typeOfSizeInterval = h.get('typeOfSizeInterval')
        ...
        if discipline == 2 and parameterCategory == 0 and parameterNumber == 22 and typeOfSecondFixedSurface == 106 and typeOfFirstFixedSurface == 106 and scaledValueOfSecondFixedSurface == 10 and scaleFactorOfSecondFixedSurface == 1 and scaleFactorOfFirstFixedSurface == 0 and scaledValueOfFirstFixedSurface == 0:
            return 'sm100'

        if discipline == 2 and parameterCategory == 0 and parameterNumber == 2 and typeOfSecondFixedSurface == 106 and typeOfFirstFixedSurface == 106 and scaledValueOfFirstFixedSurface == 0 and scaledValueOfSecondFixedSurface == 2 and scaleFactorOfSecondFixedSurface == 1 and scaleFactorOfFirstFixedSurface == 0:
            return 'st20'

        if discipline == 2 and parameterCategory == 0 and parameterNumber == 2 and typeOfSecondFixedSurface == 106 and typeOfFirstFixedSurface == 106 and scaleFactorOfSecondFixedSurface == 1 and scaleFactorOfFirstFixedSurface == 0 and scaledValueOfFirstFixedSurface == 0 and scaledValueOfSecondFixedSurface == 10:
            return 'st100'
        ...
        if discipline == 0 and parameterCategory == 1 and parameterNumber == 52 and typeOfFirstFixedSurface == 1 and typeOfStatisticalProcessing == 1 and productDefinitionTemplateNumber == 9 and scaleFactorOfLowerLimit == 0 and probabilityType == 3 and scaledValueOfLowerLimit == 10:
            return 'tpg10'

        if discipline == 0 and parameterCategory == 1 and parameterNumber == 52 and probabilityType == 3 and typeOfFirstFixedSurface == 1 and scaleFactorOfLowerLimit == 0 and productDefinitionTemplateNumber == 9 and scaledValueOfLowerLimit == 20 and typeOfStatisticalProcessing == 1:
            return 'tpg20'
        ...
        if discipline == 0 and parameterCategory == 2 and parameterNumber == 1 and scaledValueOfFirstFixedSurface == 10 and typeOfFirstFixedSurface == 103 and scaleFactorOfFirstFixedSurface == 0:
            return '10si'
        ...
        if discipline == 0 and parameterCategory == 2 and parameterNumber == 22 and typeOfFirstFixedSurface == 103 and productDefinitionTemplateNumber == 9 and typeOfStatisticalProcessing == 2 and scaledValueOfFirstFixedSurface == 10 and probabilityType == 3 and scaleFactorOfFirstFixedSurface == 0 and scaleFactorOfLowerLimit == 0 and scaledValueOfLowerLimit == 15:
            return '10fgg15'

        if discipline == 0 and parameterCategory == 2 and parameterNumber == 22 and probabilityType == 3 and scaleFactorOfLowerLimit == 0 and scaleFactorOfFirstFixedSurface == 0 and scaledValueOfLowerLimit == 20 and typeOfFirstFixedSurface == 103 and productDefinitionTemplateNumber == 9 and typeOfStatisticalProcessing == 2 and scaledValueOfFirstFixedSurface == 10:
            return '10fgg20'
        ...
        if discipline == 2 and parameterCategory == 3 and parameterNumber == 12 and typeOfFirstFixedSurface == 106 and typeOfSecondFixedSurface == 106 and scaleFactorOfFirstFixedSurface == 0 and scaledValueOfSecondFixedSurface == 2 and scaledValueOfFirstFixedSurface == 0 and scaleFactorOfSecondFixedSurface == 1:
            return 'cap'
