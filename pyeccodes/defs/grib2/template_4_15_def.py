...
def load(h):
    ...
    h.add(_.Codetable('statisticalProcess', 1, "grib2/tables/[tablesVersion]/4.10.table"))
    h.add(_.Codetable('spatialProcessing', 1, "grib2/tables/[tablesVersion]/4.15.table"))
    h.add(_.Unsigned('numberOfPointsUsed', 1))
