def load(h):
    return ({'abbr': 0, 'code': 0, 'title': 'Specific humidity', 'units': 'kg/kg'},
            ...
            {'abbr': 129,
             'code': 129,
             'title': 'Effective radius of cloud water',
             'units': 'm'},
            {'abbr': 130, 'code': 130, 'title': 'Effective radius of rain', 'units': 'm'},
            {'abbr': 131,
             'code': 131,
             'title': 'Effective radius of cloud ice',
             'units': 'm'},
            {'abbr': 132, 'code': 132, 'title': 'Effective radius of snow', 'units': 'm'},
            {'abbr': 133,
             'code': 133,
             'title': 'Effective radius of graupel',
             'units': 'm'},
            {'abbr': 134, 'code': 134, 'title': 'Effective radius of hail', 'units': 'm'},
            {'abbr': 135,
             'code': 135,
             'title': 'Effective radius of subgrid liquid clouds',
             'units': 'm'},
            {'abbr': 136,
             'code': 136,
             'title': 'Effective radius of subgrid ice clouds',
             'units': 'm'},
            {'abbr': 137,
             'code': 137,
             'title': 'Effective aspect ratio of rain',
             'units': '-'},
            {'abbr': 138,
             'code': 138,
             'title': 'Effective aspect ratio of cloud ice',
             'units': '-'},
            {'abbr': 139,
             'code': 139,
             'title': 'Effective aspect ratio of snow',
             'units': '-'},
            {'abbr': 140,
             'code': 140,
             'title': 'Effective aspect ratio of graupel',
             'units': '-'},
            {'abbr': 141,
             'code': 141,
             'title': 'Effective aspect ratio of hail',
             'units': '-'},
            {'abbr': 142,
             'code': 142,
             'title': 'Effective aspect ratio of subgrid ice clouds',
             'units': '-'},
