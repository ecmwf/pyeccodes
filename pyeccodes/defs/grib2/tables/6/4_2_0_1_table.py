def load(h):
    return ({'abbr': 0, 'code': 0, 'title': 'Specific humidity', 'units': 'kg kg-1'},
            ...
            {'abbr': 17, 'code': 17, 'title': 'Snow age day', 'units': '-'},
            ...
            {'abbr': 63, 'code': 63, 'title': 'Reserved', 'units': '-'},
            {'abbr': 64,
             'code': 64,
            ...
            {'abbr': 69,
             'code': 69,
             'title': 'Total column integrated cloud water - validation',
             'units': 'kg m-2'},
            {'abbr': 70,
             'code': 70,
             'title': 'Total column integrated cloud ice - validation',
             'units': 'kg m-2'},
            {'abbr': 71,
             'code': 71,
             'title': 'Hail mixing ratio - validation',
             'units': 'kg kg-1'},
            {'abbr': 72,
             'code': 72,
             'title': 'Total column integrated hail - validation',
             'units': 'kg m-2'},
            {'abbr': 73,
             'code': 73,
             'title': 'Hail precipitation rate - validation',
             'units': 'kg m-2 s-1'},
            {'abbr': 74,
             'code': 74,
             'title': 'Total column integrated graupel - validation',
             'units': 'kg m-2'},
            {'abbr': 75,
             'code': 75,
             'title': 'Graupel (snow pellets) precipitation rate - validation',
             'units': 'kg m-2 s-1'},
            {'abbr': 76,
             'code': 76,
             'title': 'Convective rain rate - validation',
             'units': 'kg m-2 s-1'},
            {'abbr': 77,
             'code': 77,
             'title': 'Large scale rain rate - validation',
             'units': 'kg m-2 s-1'},
            {'abbr': 78,
             'code': 78,
             'title': 'Total column integrated water (all components incl. precipitation) '
                      '- validation',
             'units': 'kg m-2'},
            {'abbr': 79,
             'code': 79,
             'title': 'Evaporation rate - validation',
             'units': 'kg m-2 s-1'},
            {'abbr': 80,
             'code': 80,
             'title': 'Total Condensate - validation',
             'units': 'kg kg-1'},
            {'abbr': 81,
             'code': 81,
             'title': 'Total Column-Integrated Condensate - validation',
             'units': 'kg m-2'},
            {'abbr': 82,
             'code': 82,
             'title': 'Cloud Ice Mixing-Ratio - validation',
             'units': 'kg kg-1'},
            {'abbr': 83,
             'code': 83,
