def load(h):
    return ({'abbr': 0, 'code': 0, 'title': 'Visibility', 'units': 'm'},
            ...
            {'abbr': 28,
             'code': 28,
             'title': 'Mountain wave turbulence (eddy dissipation rate)',
             'units': 'm2/3 s-1'},
            {'abbr': 29,
             'code': 29,
            ...
            {'abbr': 30,
             'code': 30,
             'title': 'Eddy dissipation parameter',
             'units': 'm2/3 s-1'},
            {'abbr': 31,
             'code': 31,
             'title': 'Maximum of eddy dissipation parameter in layer',
             'units': 'm2/3 s-1'},
            {'abbr': 32, 'code': 32, 'title': 'Highest freezing level', 'units': 'm'},
            {'abbr': 33,
             'code': 33,
             'title': 'Visibility through liquid fog',
             'units': 'm'},
            {'abbr': 34, 'code': 34, 'title': 'Visibility through ice fog', 'units': 'm'},
            {'abbr': 35,
             'code': 35,
             'title': 'Visibility through blowing snow',
             'units': 'm'},
            {'abbr': 36,
             'code': 36,
             'title': 'Presence of snow squalls',
