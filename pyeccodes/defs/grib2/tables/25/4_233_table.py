def load(h):
    return ({'abbr': 0, 'code': 0, 'title': 'Ozone O3'},
            ...
            {'abbr': 20, 'code': 20, 'title': 'Dihydrogen H2'},
            {'abbr': 21, 'code': 21, 'title': 'Atomic nitrogen N'},
            {'abbr': 22, 'code': 22, 'title': 'Sulphate anion SO42-'},
            {'abbr': 23, 'code': 23, 'title': 'Atomic Radon Rn'},
            {'abbr': 24, 'code': 24, 'title': 'Mercury vapour Hg(0)'},
            {'abbr': 25, 'code': 25, 'title': 'Mercury(II) cation Hg2+'},
            ...
            {'abbr': 38, 'code': 38, 'title': 'Dioxygen O2'},
            {'abbr': 39, 'code': 39, 'title': 'Nitryl chloride NO2Cl'},
            {'abbr': 40, 'code': 40, 'title': 'Sulphuric acid H2SO4'},
            {'abbr': 41, 'code': 41, 'title': 'Hydrogen sulphide H2S'},
            {'abbr': 42, 'code': 42, 'title': 'Sulphur trioxide SO3'},
            {'abbr': 43, 'code': 43, 'title': 'Bromine Br2'},
            {'abbr': 44, 'code': 44, 'title': 'Hydrofluoric acid HF'},
            {'abbr': 45, 'code': 45, 'title': 'Sulphur hexafluoride SF6'},
            {'abbr': 46, 'code': 46, 'title': 'Chlorine Cl2'},
            {'abbr': 10000, 'code': 10000, 'title': 'Hydroxyl radical HO'},
            {'abbr': 10001, 'code': 10001, 'title': 'Methyl peroxy radical CH3OO'},
            ...
            {'abbr': 10016, 'code': 10016, 'title': 'Butane (all isomers) C4H10'},
            ...
            {'abbr': 10023, 'code': 10023, 'title': 'XyleneC8H10'},
            {'abbr': 10024, 'code': 10024, 'title': 'Methanesulphonic acid CH3SO3H'},
            {'abbr': 10025,
             'code': 10025,
             'title': 'Methylglyoxal (2-oxopropanal) CH3C(O)CHO'},
            {'abbr': 10026, 'code': 10026, 'title': 'Peroxyacetyl radical CH3C(O)OO'},
            {'abbr': 10027,
             'code': 10027,
             'title': 'Methacrylic acid (2-methylprop-2-enoic acid) CH2C(CH3)COOH'},
            {'abbr': 10028,
             'code': 10028,
             'title': 'Methacrolein (2-methylprop-2-enal) CH2C(CH3)CHO'},
            {'abbr': 10029, 'code': 10029, 'title': 'Acetone (propan-2-one) CH3C(O)CH3'},
            {'abbr': 10030, 'code': 10030, 'title': 'Ethyl dioxidanyl radical CH3CH2OO'},
            {'abbr': 10031, 'code': 10031, 'title': 'Butadiene (buta-1,3-diene) (CH2CH)2'},
            {'abbr': 10032, 'code': 10032, 'title': 'Acetaldehyde (ethanal) CH3CHO'},
            {'abbr': 10033,
             'code': 10033,
             'title': 'Glycolaldehyde (hydroxyethanal) HOCH2CHO'},
            {'abbr': 10034,
             'code': 10034,
             'title': 'Cresol (methylphenol), all isomers CH3C6H4OH'},
            {'abbr': 10035,
             'code': 10035,
             'title': 'Peracetic acid (ethaneperoxoic acid) CH3C(O)OOH'},
            {'abbr': 10036,
             'code': 10036,
             'title': '2-hydroxyethyl oxidanyl radical HOCH2CH2O'},
            {'abbr': 10037,
             'code': 10037,
             'title': '2-hydroxyethyl dioxidanyl radical HOCH2CH2OO'},
            {'abbr': 10038, 'code': 10038, 'title': 'Glyoxal (oxaldehyde) OCHCHO'},
            {'abbr': 10039,
             'code': 10039,
             'title': 'Isopropyl dioxidanyl radical (CH3)2CHOO'},
            {'abbr': 10040,
             'code': 10040,
             'title': 'Isopropyl hydroperoxide (2-hydroperoxypropane) (CH3)2CHOOH'},
            {'abbr': 10041,
             'code': 10041,
             'title': 'Hydroxyacetone (1-hydroxypropan-2-one) CH3C(O)CH2OH'},
            {'abbr': 10042,
             'code': 10042,
             'title': 'Peroxyacetic acid (ethaneperoxoic acid) CH3C(O)OOH'},
            {'abbr': 10043,
             'code': 10043,
             'title': 'Methyl vinyl ketone (but-3-en-2-one) CH3C(O)CHCH2'},
            {'abbr': 10044, 'code': 10044, 'title': 'Phenoxy radical C6H5O'},
            {'abbr': 10045, 'code': 10045, 'title': 'Methyl radical CH3'},
            {'abbr': 10046,
             'code': 10046,
             'title': 'Carbonyl sulphide (carbon oxide sulphide) OCS'},
            {'abbr': 10047, 'code': 10047, 'title': 'Dibromomethane CH2Br2'},
            {'abbr': 10048, 'code': 10048, 'title': 'Methoxy radical CH3O'},
            {'abbr': 10049, 'code': 10049, 'title': 'Tribromomethane CHBr3'},
            {'abbr': 10050,
             'code': 10050,
             'title': 'Formyl radical (oxomethyl radical) HOC'},
            {'abbr': 10051,
             'code': 10051,
             'title': 'Hydroxymethyl dioxidanyl radical HOCH2OO'},
            {'abbr': 10052, 'code': 10052, 'title': 'Ethyl hydroperoxide CH3CH2OOH'},
            {'abbr': 10053,
             'code': 10053,
             'title': '3-hydroxypropyl dioxidanyl radical HOCH2CH2CH2OO'},
            {'abbr': 10054,
             'code': 10054,
             'title': '3-hydroxypropyl hydroperoxide HOCH2CH2CH2OOH'},
            {'abbr': 10500,
             'code': 10500,
             'title': 'Dimethyl sulphide CH3SCH3',
             'units': 'DMS'},
            {'abbr': 10501, 'code': 10501, 'title': 'DMSO (dimethyl sulfoxide) (CH3)2SO'},
            {'abbr': 20001, 'code': 20001, 'title': 'Hydrogen chloride HCl'},
            {'abbr': 20002,
             'code': 20002,
             'title': 'CFC-11 (trichlorofluoromethane) CCl3F'},
            {'abbr': 20003,
             'code': 20003,
             'title': 'CFC-12 (dichlorodifluoromethane) CCl2F2'},
            {'abbr': 20004,
             'code': 20004,
             'title': 'CFC-113 (1,1,2-trichloro-1,2,2-trifluoroethane) Cl2FC-CClF2'},
            {'abbr': 20005,
             'code': 20005,
             'title': 'CFC-113a (1,1,1-trichloro-2,2,2-trifluoroethane) Cl3C-CF3'},
            {'abbr': 20006,
             'code': 20006,
             'title': 'CFC-114 (1,2-dichloro-1,1,2,2-tetrafluoroethane) ClF2C-CClF2'},
            {'abbr': 20007,
             'code': 20007,
             'title': 'CFC-115 (1-chloro-1,1,2,2,2-pentafluoroethane) ClF2C-CF3'},
            {'abbr': 20008,
             'code': 20008,
             'title': 'HCFC-22 (chlorodifluoromethane) CHClF2'},
            {'abbr': 20009,
             'code': 20009,
             'title': 'HCFC-141b (1,1-dichloro-1-fluoroethane) Cl2FC-CH3'},
            {'abbr': 20010,
             'code': 20010,
             'title': 'HCFC-142b (1-chloro-1,1-difluoroethane) ClF2C-CH3'},
            {'abbr': 20011,
             'code': 20011,
             'title': 'Halon-1202 (dibromodifluoromethane) CBr2F2'},
            {'abbr': 20012,
             'code': 20012,
             'title': 'Halon-1211 (bromochlorodifluoromethane) CBrClF2'},
            {'abbr': 20013,
             'code': 20013,
             'title': 'Halon-1301 (bromotrifluoromethane) CBrF3'},
            {'abbr': 20014,
             'code': 20014,
             'title': 'Halon-2402 (1,2-dibromo-1,1,2,2-tetrafluoroethane) BrF2C-CBrF2'},
            {'abbr': 20015, 'code': 20015, 'title': 'HCC-40 (methyl chloride) CH3Cl'},
            {'abbr': 20016, 'code': 20016, 'title': 'HCC-10 (carbon tetrachloride) CCl4'},
            {'abbr': 20017,
             'code': 20017,
             'title': 'HCC-140a (1,1,1-trichloroethane) Cl3C-CH3'},
            {'abbr': 20018, 'code': 20018, 'title': 'HBC-40B1 (methyl bromide) CH3Br'},
            {'abbr': 20019,
             'code': 20019,
             'title': 'HCH (hexachlorocyclohexane) all isomers C6H6Cl6'},
            {'abbr': 20020,
             'code': 20020,
             'title': 'alpha-HCH (alpha-hexachlorocyclohexane) both enantiomers '
                      'alpha-C6H6Cl6'},
            {'abbr': 20021,
             'code': 20021,
             'title': "PCB-153 (2,2',4,4',5,5'-hexachlorobiphenyl) (C6H2Cl3)2"},
            {'abbr': 20022,
             'code': 20022,
             'title': 'HCFC-141a (1,1-dichloro-2-fluoroethane) Cl2HC-CH2F'},
            {'abbr': 30000,
             'code': 30000,
             'title': 'Radioactive pollutant',
             'units': 'tracer, defined by originating centre'},
            {'abbr': 30010, 'code': 30010, 'title': 'Tritium (Hydrogen 3) H-3'},
            {'abbr': 30011, 'code': 30011, 'title': 'Tritium organic bounded H-3o'},
            {'abbr': 30012, 'code': 30012, 'title': 'Tritium inorganic H-3a'},
            ...
            {'abbr': 30295, 'code': 30295, 'title': 'Carbon-13 C-13'},
            {'abbr': 30296, 'code': 30296, 'title': 'Lead Pb'},
            {'abbr': 40000,
             'code': 40000,
             'title': 'Singlet sigma oxygen (dioxygen (sigma singlet)) O2'},
            {'abbr': 40001,
             'code': 40001,
             'title': 'Singlet delta oxygen (dioxygen (delta singlet)) O2'},
            {'abbr': 40002, 'code': 40002, 'title': 'Singlet excited oxygen atom O(1D)'},
            {'abbr': 40003,
             'code': 40003,
             'title': 'Triplet ground state oxygen atom O(3P)'},
            {'abbr': 60000, 'code': 60000, 'title': 'HOx radical (OH+HO2) HOx'},
            {'abbr': 60001,
             'code': 60001,
             'title': 'Total inorganic and organic peroxy radicals (HOO + ROO) ROO'},
            ...
            {'abbr': 60013,
             'code': 60013,
             'title': 'Non-methane volatile organic compounds expressed as carbon NMVOC'},
            {'abbr': 60014,
             'code': 60014,
            ...
            {'abbr': 60015,
             ...
             'title': 'Biogenic non-methane volatile organic compounds expressed as '
                      'carbon bNMVOC'},
            {'abbr': 60016, 'code': 60016, 'title': 'Lumped oxygenated hydrocarbons OVOC'},
            {'abbr': 60017,
             'code': 60017,
             'title': 'NOx expressed as nitrogen dioxide (NO2) NOx'},
            {'abbr': 60018, 'code': 60018, 'title': 'Organic aldehydes RCHO'},
            {'abbr': 60019, 'code': 60019, 'title': 'Organic peroxides ROOH'},
            {'abbr': 60020, 'code': 60020, 'title': 'Organic nitrates RNO3'},
            {'abbr': 60021, 'code': 60021, 'title': 'Ethers ROR'},
            {'abbr': 60022, 'code': 60022, 'title': 'Amines NRRR'},
            {'abbr': 60023, 'code': 60023, 'title': 'Ketones RC(O)R'},
            {'abbr': 60024,
             'code': 60024,
             'title': 'Dicarbonyls unsaturated RC(O)CH2C(O)R'},
            {'abbr': 60025,
             'code': 60025,
             'title': 'Hydroxy dicarbonyls unsaturated RC(O)CHOHC(O)R'},
            {'abbr': 60026, 'code': 60026, 'title': 'Hydroxy ketones RC(OH)C(O)R'},
            {'abbr': 60027, 'code': 60027, 'title': 'Oxides Ox'},
            ...
            {'abbr': 62028, 'code': 62028, 'title': 'Total aerosol hydrophilic'},
            {'abbr': 62029, 'code': 62029, 'title': 'Total aerosol hydrophobic'},
