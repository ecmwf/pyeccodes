...
def load(h):
    ...
    def wrapped(h):
        ...
        if discipline == 0 and parameterCategory == 1 and parameterNumber == 52 and scaleFactorOfLowerLimit == 0 and typeOfFirstFixedSurface == 1 and productDefinitionTemplateNumber == 9 and typeOfStatisticalProcessing == 1 and scaledValueOfLowerLimit == 100 and probabilityType == 3:
            return 'tpg100'
        ...
        if discipline == 0 and parameterCategory == 0 and parameterNumber == 0 and scaledValueOfFirstFixedSurface == 2 and typeOfFirstFixedSurface == 103 and lengthOfTimeRange == 24 and scaleFactorOfFirstFixedSurface == 0 and typeOfStatisticalProcessing == 2 and indicatorOfUnitForTimeRange == 1:
            return 'mx2t24'

        if discipline == 0 and parameterCategory == 0 and parameterNumber == 0 and lengthOfTimeRange == 24 and scaleFactorOfFirstFixedSurface == 0 and typeOfStatisticalProcessing == 3 and indicatorOfUnitForTimeRange == 1 and scaledValueOfFirstFixedSurface == 2 and typeOfFirstFixedSurface == 103:
            return 'mn2t24'
        ...
        localTablesVersion = h.get('localTablesVersion')
        ...
        if localTablesVersion == 1 and discipline == 0 and parameterCategory == 20 and parameterNumber == 2 and is_aerosol == 1 and aerosolType == 65533:
            return 'aermr17'
        ...
        if discipline == 0 and parameterCategory == 0 and parameterNumber == 0 and typeOfStatisticalProcessing == 2 and lengthOfTimeRange == 3 and indicatorOfUnitForTimeRange == 1 and typeOfFirstFixedSurface == 103 and scaleFactorOfFirstFixedSurface == 0 and scaledValueOfFirstFixedSurface == 2:
            return 'mx2t3'

        if discipline == 0 and parameterCategory == 0 and parameterNumber == 0 and indicatorOfUnitForTimeRange == 1 and typeOfFirstFixedSurface == 103 and scaleFactorOfFirstFixedSurface == 0 and scaledValueOfFirstFixedSurface == 2 and typeOfStatisticalProcessing == 3 and lengthOfTimeRange == 3:
            return 'mn2t3'
        ...
        if discipline == 0 and parameterCategory == 2 and parameterNumber == 22 and scaledValueOfFirstFixedSurface == 10 and productDefinitionTemplateNumber == 9 and scaleFactorOfLowerLimit == 0 and typeOfStatisticalProcessing == 2 and scaledValueOfLowerLimit == 25 and typeOfFirstFixedSurface == 103 and probabilityType == 3 and scaleFactorOfFirstFixedSurface == 0:
            return 'fg10g25'

        if discipline == 192 and parameterCategory == 131 and parameterNumber == 73:
            return 't2l273'

        if discipline == 10 and parameterCategory == 0 and parameterNumber == 3 and scaledValueOfLowerLimit == 2 and scaleFactorOfLowerLimit == 0 and typeOfFirstFixedSurface == 101 and productDefinitionTemplateNumber == 5 and probabilityType == 3:
            return 'swhg2'

        if discipline == 10 and parameterCategory == 0 and parameterNumber == 3 and typeOfFirstFixedSurface == 101 and productDefinitionTemplateNumber == 5 and scaleFactorOfLowerLimit == 0 and probabilityType == 3 and scaledValueOfLowerLimit == 4:
            return 'swhg4'
