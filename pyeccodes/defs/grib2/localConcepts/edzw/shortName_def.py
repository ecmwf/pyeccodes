...
def load(h):
    ...
    def wrapped(h):
        ...
        constituentType = h.get('constituentType')
        ...
        satelliteSeries = h.get('satelliteSeries')
        satelliteNumber = h.get('satelliteNumber')
        ...
        scaledValueOfCentralWaveNumber = h.get('scaledValueOfCentralWaveNumber')
        ...
        numberOfGridInReference = h.get('numberOfGridInReference')
        ...
        modeNumber = h.get('modeNumber')
        typeOfDistributionFunction = h.get('typeOfDistributionFunction')
