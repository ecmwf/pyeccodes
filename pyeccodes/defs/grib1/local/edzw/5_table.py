def load(h):
    return ({'abbr': 0,
            ...
            {'abbr': 11,
             'code': 11,
             'title': 'local use: Initialized forecast (P1 > 0) for IDFI'},
            {'abbr': 13,
             'code': 13,
             'title': 'local use: Fields from analyses valid at reference time for P1 = '
                      '0'},
            {'abbr': 14,
             'code': 14,
             'title': 'local use: IFS forecast interpolated to GME triangular grid'},
