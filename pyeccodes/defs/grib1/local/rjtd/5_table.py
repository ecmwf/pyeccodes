def load(h):
    return ({'abbr': 0,
            ...
            {'abbr': 129,
             'code': 129,
             'title': 'Temporal variance of N forecasts; each product has valid time '
                      'ranging between reference time + P1 and reference time + P2; '
                      'products have reference times at intervals of 24 hours, beginning '
                      'at the given reference time; unit of measurement is square of that '
                      'in Code Table 2'},
            {'abbr': 130,
             'code': 130,
            ...
            {'abbr': 131,
             'code': 131,
             'title': 'Temporal variance of N forecasts; valid time of the first product '
                      'ranges between R + P1 and R + P2, where R is reference time given '
                      'in octets 13 to 17, then subsequent products have valid time range '
                      'at interval of P2 - P1; thus all N products cover continuous time '
                      'span; products have reference times at intervals of P2 - P1, '
                      'beginning at the given reference time; unit of measurement is '
                      'square of that in Code Table 2'},
            {'abbr': 132,
             'code': 132,
             'title': 'Temporal variance of N uninitialized analyses [P1 = 0] or '
                      'instantaneous forecasts [P1 > 0]; each product has valid time at '
                      'the reference time + P1; products have reference times at '
                      'intervals of P2, beginning at the given reference time; unit of '
                      'measurement is square of that in Code Table 2'})
