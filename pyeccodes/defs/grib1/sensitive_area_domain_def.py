...
def load(h):
    ...
    def wrapped(h):
        ...
        northWestLatitudeOfVerficationArea = h.get('northWestLatitudeOfVerficationArea')
        northWestLongitudeOfVerficationArea = h.get('northWestLongitudeOfVerficationArea')
        southEastLatitudeOfVerficationArea = h.get('southEastLatitudeOfVerficationArea')
        southEastLongitudeOfVerficationArea = h.get('southEastLongitudeOfVerficationArea')
