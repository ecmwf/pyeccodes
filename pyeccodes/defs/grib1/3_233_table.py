def load(h):
    return ({'abbr': 0, 'code': 0, 'title': 'Reserved'},
            ...
            {'abbr': 'umx', 'code': 6, 'title': 'Maximum wind speed level'},
            {'abbr': 'trp', 'code': 7, 'title': 'Tropopause level'},
            {'abbr': 'toa', 'code': 8, 'title': 'Nominal top of atmosphere'},
            {'abbr': 9, 'code': 9, 'title': 'Sea bottom'},
            {'abbr': 'tl', 'code': 20, 'title': 'Isothermal level Temperature in 1/100 K'},
            {'abbr': 'pl',
             'code': 100,
            ...
            {'abbr': 'dn',
             'code': 191,
             'title': 'Northern facing surface',
             'units': 'HIRLAM Extension'},
            {'abbr': 'dne',
             'code': 192,
             'title': 'North-eastern facing surface',
             'units': 'HIRLAM Extension'},
            {'abbr': 'de',
             'code': 193,
             'title': 'Eastern facing surface',
             'units': 'HIRLAM Extension'},
            {'abbr': 'dse',
             'code': 194,
             'title': 'South-eastern facing surface',
             'units': 'HIRLAM Extension'},
            {'abbr': 'ds',
             'code': 195,
             'title': 'Southern facing surface',
             'units': 'HIRLAM Extension'},
            {'abbr': 'dsw',
             'code': 196,
             'title': 'South-western facing surface',
             'units': 'HIRLAM Extension'},
            {'abbr': 'dw',
             'code': 197,
             'title': 'Western facing surface',
             'units': 'HIRLAM Extension'},
            {'abbr': 'dw',
             'code': 198,
             'title': 'North-western facing surface',
             'units': 'HIRLAM Extension'},
            {'abbr': 'atm',
             'code': 200,
